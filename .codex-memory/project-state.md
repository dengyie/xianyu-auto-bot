...
- Next testing priorities:
  - evaluate whether any broader route or service entrypoint still needs coverage beyond the now-covered runtime detail-refresh, message-handoff, delivery-recovery, refresh, history-sync, and password-login seams
  - evaluate whether the remaining uncovered risk now sits outside the order delivery/refresh/history-sync/login paths and belongs to a different module cluster
