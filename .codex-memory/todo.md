...
## In Progress
- [ ] Stage, commit, and push phase 47 qr-login ownership coverage to the draft GitHub PR

## Next
- [ ] Evaluate whether any broader route or service entrypoint still needs coverage beyond the now-covered runtime detail-refresh, message-handoff, delivery, refresh, history-sync, password-login, manual-cookie-import, and qr-login seams
- [ ] Evaluate whether the remaining uncovered risk is now outside the delivery/retry, refresh, history-sync, password-login, manual-cookie-import, and qr-login chains and belongs to a different module cluster
