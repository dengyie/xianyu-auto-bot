...
pip install --no-deps "slidex @ git+https://github.com/dengyie/slidex.git@3d56952ef44b209ce3a80fc3b0ee0983d825708d"
...
Playwright 固定为 `1.59.0`。`slidex` 因为是 VCS 依赖，不能参与 pip 的 `--require-hashes`，因此从主锁文件中排除，并以 `--no-deps` 单独安装固定提交 `3d56952ef44b209ce3a80fc3b0ee0983d825708d`（0.6.1）；其余依赖仍全部强制哈希校验。
